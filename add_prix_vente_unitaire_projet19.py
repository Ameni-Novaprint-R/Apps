"""
Script pour ajouter la colonne PrixVenteUnitaire à la table WEB_S_DOS_ENCOURS
Projet 19 - Gestion des Dossiers en Cours
Calcul : PrxVteReel / QteComm depuis COMMANDES (lecture seule)
"""
import sys
import io
...
def add_prix_vente_unitaire_column():
    """Ajoute la colonne PrixVenteUnitaire si elle n'existe pas"""
    try:
        with get_db_cursor() as cursor:
            print("=" * 80)
            print("AJOUT DE LA COLONNE PrixVenteUnitaire À WEB_S_DOS_ENCOURS")
            print("=" * 80)
            print()
            ...
            if col_exists:
                ...
                print("⚠️  La colonne PrixVenteUnitaire n'existe pas encore")
                ...
                try:
                    ...
                    print("✅ Colonne PrixVenteUnitaire ajoutée avec succès!")
                    print()
...
if __name__ == "__main__":
    add_prix_vente_unitaire_column()
